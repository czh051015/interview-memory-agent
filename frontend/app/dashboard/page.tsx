...
export default function DashboardPage() {
  ...
  const nav = (
    <div className="ml-auto flex items-center gap-2 text-[11px] text-zinc-400">
      ...
      <a href="/mock-interview" className="px-2.5 py-1 rounded-lg border border-zinc-200 text-zinc-500 hover:bg-zinc-50 hover:text-indigo-600 transition-colors">
        🎯 模拟面试
      </a>
      <a href="/workbench" className="px-2.5 py-1 rounded-lg border border-indigo-200 text-indigo-600 bg-indigo-50/60 hover:bg-indigo-100 transition-colors">
        📝 申论工作台
      </a>
    </div>
  );
    ...
    <div className="min-h-dvh bg-zinc-50/50">
      <div className="max-w-3xl mx-auto w-full bg-white min-h-dvh shadow-sm border-x border-zinc-200">
        ...
        <div className="flex items-center gap-3 px-5 py-3 border-b border-zinc-200 bg-white shrink-0 sticky top-0 z-10">
          <a href="/workbench" className="w-8 h-8 rounded-lg bg-indigo-600 flex items-center justify-center text-white text-sm font-bold hover:bg-indigo-700 transition-colors">
            O
          </a>
          <div>
